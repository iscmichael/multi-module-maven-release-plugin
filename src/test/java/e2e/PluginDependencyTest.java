    ...
    public void runWithPluginDependencyWithoutCommitInOpenApiSpecShouldSucceed() throws Exception {
        ...
        assertThat(
                ...
                allOf(
                        ...
                        oneOf(containsString("Included: io.github.iscmichael.mavenplugins.testprojects.openapi-spec-as-plugin-dependency:the-openapi-spec:jar:1.0.1"))
                )
        );
        ...
        assertThat(
                ...
                allOf(
                        ...
                        oneOf(containsString("Populating class realm plugin>org.openapitools:openapi-generator-maven-plugin")),
                        oneOf(containsString("Included: io.github.iscmichael.mavenplugins.testprojects.openapi-spec-as-plugin-dependency:the-openapi-spec:jar:1.0.2"))
                )
        );
